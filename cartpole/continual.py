...
from cartpole.benchmark import ContinualCartPole, make_benchmark
from cartpole.callbacks import make_callbacks
...
def run_continual(
    ...
    envs_train = make_benchmark(benchmark, encode_task=True, seed=42)
    envs_test = make_benchmark(benchmark, encode_task=True, seed=43)
