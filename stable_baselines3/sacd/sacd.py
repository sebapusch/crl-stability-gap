...
from stable_baselines3.sacd.policies import Actor, CnnPolicy, DiscreteCritic, MlpPolicy, MultiInputPolicy, SACDPolicy
...
class SACD(OffPolicyAlgorithm):
    ...
    def train(self, gradient_steps: int, batch_size: int = 64, task_ix: int = 0) -> None:
        ...
        self.logger.record('train/critic_reg_loss', float(critic_aux_loss.detach()))
        self.logger.record('train/actor_reg_loss', float(actor_aux_loss.detach()))
